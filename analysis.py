...
#        plt.axhline(y=Unit[2], color='r', linestyle=':')        
#    plt.show()
    return 'multi-plot grid of '+Constituent + Unit[0]





def AnaVSPot6( DataX ,   Station , Constituent , time ):
    ...
    ffff = pd.pivot_table(DataX, Constituent , "Watershed" , time ,aggfunc='mean')
    
    #f, ax = plt.subplots(figsize=(9, 6))
    plt.figure(4,figsize=(9, 6))
    
    sns.heatmap(ffff, annot=False,  linewidths=.5)
    
 
    return 'Heatmap of '+Constituent + Unit[0] 